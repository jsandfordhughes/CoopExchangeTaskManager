...
const classes = computed(() => {
    return props.active
        ? 'block w-full ps-3 pe-4 py-2 border-l-4 border-accent text-start text-base font-medium text-white focus:outline-none focus:text-accent focus:border-indigo-700 transition duration-150 ease-in-out'
